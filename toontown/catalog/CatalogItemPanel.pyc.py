# 2013.08.22 22:17:11 Pacific Daylight Time
...
class CatalogItemPanel(DirectFrame):
    ...
    def handleSoundOffButton(self):
        ...
        if hasattr(item, 'changeIval'):
            ...
            self.ival.loop()
        return
# okay decompyling C:\Users\Maverick\Documents\Visual Studio 2010\Projects\Unfreezer\py2\toontown\catalog\CatalogItemPanel.pyc 
