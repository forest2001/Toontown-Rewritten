...
MonthlySchedule = ((7,
 ...
 (1,
  ...
  (
   ...
   CatalogClothingItem(1608, 0, 60),
   CatalogClothingItem(1605, 0, 60),
   CatalogClothingItem(1602, 0, 60),
   CatalogClothingItem(1607, 0, 40),
   CatalogClothingItem(1604, 0, 40),
   CatalogClothingItem(1601, 0, 40),
   CatalogClothingItem(1606, 0, 20),
   CatalogClothingItem(1603, 0, 20),
   CatalogClothingItem(1600, 0, 20),
   CatalogEmoteItem(20, 20),
   CatalogEmoteItem(21, 40),
   CatalogEmoteItem(22, 60),
   CatalogEmoteItem(23, 80),
   CatalogEmoteItem(24, 100))),
 (5,
  26,
  6,
  30,
