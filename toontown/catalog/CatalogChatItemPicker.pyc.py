# 2013.08.22 22:17:01 Pacific Daylight Time
...
class CatalogChatItemPicker(DirectObject.DirectObject):
    ...
    def __handleDeleteConfirm(self):
        ...
        if status == 'ok':
            ...
            self.show()
        return
# okay decompyling C:\Users\Maverick\Documents\Visual Studio 2010\Projects\Unfreezer\py2\toontown\catalog\CatalogChatItemPicker.pyc 
