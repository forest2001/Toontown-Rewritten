...
PhaseToMusicData = {3.5: {'TC_SZ.mid': [TTLocalizer.MusicTcSz, 57]},
 ...
 6: {'DD_SZ.mid': [TTLocalizer.MusicDdSz, 33],
 ...
 8: {'DG_SZ.mid': [TTLocalizer.MusicDgSz, 48],
     'DL_SZ.mid': [TTLocalizer.MusicDlSz, 33],
     'TB_SZ.mid': [TTLocalizer.MusicTbSz, 54]},
 9: {'encntr_hall_of_fame.mid': [TTLocalizer.MusicEncntrHallOfFame, 51],
     'encntr_head_suit_theme.mid': [TTLocalizer.MusicEncntrHeadSuitTheme, 29]},
 11: {'LB_juryBG.mid': [TTLocalizer.MusicLbJurybg, 30]},
 13: {'party_original_theme.mid': [TTLocalizer.MusicPartyOriginalTheme, 56],
      'party_generic_theme_jazzy.mid': [TTLocalizer.MusicPartyGenericThemeJazzy, 64]}}
PhaseToMusicData40 = {3.5: {'encntr_general_bg.mid': [TTLocalizer.MusicEncntrGeneralBg, 30],
       'TC_SZ.mid': [TTLocalizer.MusicTcSz, 57]},
 3: {'create_a_toon.mid': [TTLocalizer.MusicCreateAToon, 175],
     'tt_theme.mid': [TTLocalizer.MusicTtTheme, 51]},
 4: {'minigame_race.mid': [TTLocalizer.MusicMinigameRace, 77],
 ...
 7: {'encntr_general_bg_indoor.mid': [TTLocalizer.MusicEncntrGeneralBgIndoor, 31],
     'encntr_suit_winning_indoor.mid': [TTLocalizer.MusicEncntrGeneralSuitWinningIndoor, 36]},
 8: {'DL_nbrhood.mid': [TTLocalizer.MusicDlNbrhood, 30],
 ...
 12: {'Bossbot_Factory_v1.mid': [TTLocalizer.MusicBossbotFactoryV1, 30],
