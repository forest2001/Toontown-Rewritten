...
MinigamePlayerMatrix = {
    1: (CannonGameId, MazeGameId, RingGameId, TwoDGameId),
    2: (CannonGameId, MazeGameId, PatternGameId, TagGameId, RingGameId, IceGameId, TwoDGameId),
    3: (CannonGameId, MazeGameId, PatternGameId, RaceGameId, TagGameId, RingGameId, IceGameId, TwoDGameId),
    4: (CannonGameId, MazeGameId, PatternGameId, RaceGameId, TagGameId, RingGameId, IceGameId, TwoDGameId),
}
