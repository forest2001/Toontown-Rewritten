...
LOW_POP = 70 # This is 'Ideal' in the book (green)
MID_POP = 130 # This is 'Full' in the book, but friends can still TP onto shard (soft red)
HIGH_POP = 150 # Still 'Full' in book, but nobody joins this shard for any reason (hard red)
