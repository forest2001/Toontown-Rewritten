...
MID_POP = 200 # This is 'Full' in the book, but friends can still TP onto shard (soft red)
HIGH_POP = 230 # Still 'Full' in book, but nobody joins this shard for any reason (hard red)
