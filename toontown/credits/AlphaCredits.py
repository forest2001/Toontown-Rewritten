...
class Hamlet:
    ...
    def load(self):
        ...
        self.image = OnscreenImage(image='phase_4/maps/news/hamlet.jpg', pos=(0.5, 1, 0.0), scale=(0.5, 0.30, 0.30))
...
class MuddyPaws:
    ...
    def load(self):
        ...
        self.image = OnscreenImage(image='phase_4/maps/news/muddy-paws.jpg', pos=(0.5, 1, 0.0), scale=(0.5, 0.30, 0.30))
...
class Goshi:
    ...
    def load(self):
        self.sceneRoot = NodePath('Goshi')

        self.title = OnscreenText(text='Goshi', pos=(0.65, 0.15, 0.0), scale=(0.15), fg=(1, 1, 1, 1), font=ToontownGlobals.getSignFont(), align=TextNode.ACenter)
        self.description = OnscreenText(text='Support Manager\nModerator', pos=(0.25, 0.05, 0.0), scale=(0.06), fg=(1, 1, 1, 1), font=ToontownGlobals.getMinnieFont(), align=TextNode.ALeft)
        self.image = OnscreenImage(image='phase_4/maps/news/14-4-1_itsabirthdefect-nothingsilly.jpg', pos=(-0.5, 0.0, 0.0), scale=(0.5, 0.30, 0.30))
...
class TooManySecrets:
    ...
    def load(self):
        ...
        self.title = OnscreenText(text='Too Many Secrets', pos=(0.65, 0.15, 0.0), scale=(0.15), fg=(1, 1, 1, 1), font=ToontownGlobals.getSignFont(), align=TextNode.ACenter)
        self.description = OnscreenText(text='Many Secret Things\nDeveloper', pos=(0.25, 0.05, 0.0), scale=(0.06), fg=(1, 1, 1, 1), font=ToontownGlobals.getMinnieFont(), align=TextNode.ALeft)
        self.image = OnscreenImage(image='phase_4/maps/news/toomanysecrets.jpg', pos=(-0.5, 0.0, 0.0), scale=(0.5, 0.30, 0.30))
