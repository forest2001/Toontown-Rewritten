...
class DistributedGolfHole(DistributedPhysicsWorld.DistributedPhysicsWorld, FSM, GolfHoleBase.GolfHoleBase):
    ...
    def _adjustCamera--- This code section failed: ---
...
21	LOAD_FAST         'self'
24	LOAD_ATTR         '_adjustCamera'
27	LOAD_CONST        'first'
30	LOAD_GLOBAL       'False'
33	CALL_FUNCTION_256 None
36	POP_TOP           None

37	LOAD_FAST         'self'
40	LOAD_ATTR         '_camAdjust'
43	LOAD_ATTR         'iters'
46	LOAD_CONST        0
49	COMPARE_OP        '=='
52	JUMP_IF_FALSE     '65'
...
72	LOAD_CONST        5
75	STORE_FAST        'MaxIters'

78	LOAD_FAST         'self'
81	LOAD_ATTR         '_camAdjust'
84	LOAD_ATTR         'lower'
87	STORE_FAST        'finalP'

90	LOAD_GLOBAL       'localAvatar'
93	LOAD_ATTR         'stash'
...
100	SETUP_LOOP        '130'
103	LOAD_FAST         'self'
106	LOAD_ATTR         '_golfBarrierCollection'
109	GET_ITER          None
110	FOR_ITER          '129'
113	STORE_FAST        'barrier'

116	LOAD_FAST         'barrier'
119	LOAD_ATTR         'stash'
...
130	LOAD_FAST         'self'
133	LOAD_ATTR         'ccTrav'
136	LOAD_ATTR         'traverse'
...
146	SETUP_LOOP        '176'
149	LOAD_FAST         'self'
152	LOAD_ATTR         '_golfBarrierCollection'
155	GET_ITER          None
156	FOR_ITER          '175'
159	STORE_FAST        'barrier'

162	LOAD_FAST         'barrier'
165	LOAD_ATTR         'unstash'
...
176	LOAD_GLOBAL       'localAvatar'
179	LOAD_ATTR         'unstash'
182	CALL_FUNCTION_0   None
185	POP_TOP           None

186	LOAD_FAST         'self'
189	LOAD_ATTR         '_camAdjust'
192	LOAD_ATTR         'lower'
195	LOAD_FAST         'self'
198	LOAD_ATTR         '_camAdjust'
201	LOAD_ATTR         'upper'
204	BINARY_ADD        None
205	LOAD_CONST        2
208	BINARY_DIVIDE     None
209	STORE_FAST        'midP'

212	LOAD_FAST         'self'
215	LOAD_ATTR         'camCollisionQueue'
218	LOAD_ATTR         'getNumEntries'
221	CALL_FUNCTION_0   None
224	LOAD_CONST        0
227	COMPARE_OP        '>'
230	JUMP_IF_FALSE     '328'

233	LOAD_FAST         'self'
236	LOAD_ATTR         'camCollisionQueue'
239	LOAD_ATTR         'sortEntries'
242	CALL_FUNCTION_0   None
245	POP_TOP           None

246	LOAD_FAST         'self'
249	LOAD_ATTR         'camCollisionQueue'
252	LOAD_ATTR         'getEntry'
255	LOAD_CONST        0
258	CALL_FUNCTION_1   None
261	STORE_FAST        'entry'

264	LOAD_FAST         'entry'
267	LOAD_ATTR         'getSurfacePoint'
270	LOAD_FAST         'self'
273	LOAD_ATTR         'camPivot'
276	CALL_FUNCTION_1   None
279	STORE_FAST        'sPoint'

282	LOAD_FAST         'self'
285	LOAD_ATTR         'camPivot'
288	LOAD_ATTR         'getP'
291	CALL_FUNCTION_0   None
294	LOAD_FAST         'self'
297	LOAD_ATTR         '_camAdjust'
300	STORE_ATTR        'lower'

303	LOAD_FAST         'midP'
306	STORE_FAST        'finalP'

309	LOAD_FAST         'self'
312	LOAD_ATTR         'camPivot'
315	LOAD_ATTR         'setP'
318	LOAD_FAST         'finalP'
321	CALL_FUNCTION_1   None
324	POP_TOP           None
325	JUMP_FORWARD      '426'

328	LOAD_FAST         'self'
331	LOAD_ATTR         'camPivot'
334	LOAD_ATTR         'getP'
337	CALL_FUNCTION_0   None
340	LOAD_FAST         'self'
343	LOAD_ATTR         '_camAdjust'
346	STORE_ATTR        'upper'

349	LOAD_FAST         'self'
352	LOAD_ATTR         '_camAdjust'
355	LOAD_ATTR         'upper'
358	STORE_FAST        'finalP'

361	LOAD_FAST         'self'
364	LOAD_ATTR         'camPivot'
367	LOAD_ATTR         'setP'
370	LOAD_FAST         'midP'
...
377	LOAD_GLOBAL       'abs'
380	LOAD_FAST         'self'
383	LOAD_ATTR         '_camAdjust'
386	LOAD_ATTR         'lower'
389	LOAD_FAST         'self'
392	LOAD_ATTR         '_camAdjust'
395	LOAD_ATTR         'upper'
398	BINARY_SUBTRACT   None
399	CALL_FUNCTION_1   None
402	LOAD_CONST        1.0
405	COMPARE_OP        '<'
408	JUMP_IF_FALSE     '426'

411	LOAD_FAST         'MaxIters'
414	LOAD_FAST         'self'
417	LOAD_ATTR         '_camAdjust'
420	STORE_ATTR        'iters'
423	JUMP_FORWARD      '426'
426_0	COME_FROM         '325'
426_1	COME_FROM         '423'

426	LOAD_FAST         'self'
429	LOAD_ATTR         '_camAdjust'
432	DUP_TOP           None
433	LOAD_ATTR         'iters'
436	LOAD_CONST        1
439	INPLACE_ADD       None
440	ROT_TWO           None
441	STORE_ATTR        'iters'

444	LOAD_FAST         'self'
447	LOAD_ATTR         '_camAdjust'
450	LOAD_ATTR         'iters'
453	LOAD_FAST         'MaxIters'
456	COMPARE_OP        '>='
459	JUMP_IF_FALSE     '579'

462	LOAD_FAST         'self'
465	LOAD_ATTR         'targetCamPivot'
468	LOAD_ATTR         'setP'
471	LOAD_FAST         'self'
474	LOAD_ATTR         '_camAdjust'
477	LOAD_ATTR         'upper'
480	CALL_FUNCTION_1   None
483	POP_TOP           None

484	LOAD_FAST         'task'
487	LOAD_CONST        None
490	COMPARE_OP        'is'
493	JUMP_IF_FALSE     '515'

496	LOAD_FAST         'self'
499	LOAD_ATTR         'curCamPivot'
502	LOAD_ATTR         'setP'
505	LOAD_FAST         'finalP'
...
515	LOAD_CONST        0
518	LOAD_FAST         'self'
521	LOAD_ATTR         '_camAdjust'
524	STORE_ATTR        'iters'

527	LOAD_FAST         'self'
530	LOAD_ATTR         'DefaultCamP'
533	LOAD_FAST         'self'
536	LOAD_ATTR         '_camAdjust'
539	STORE_ATTR        'lower'

542	LOAD_FAST         'self'
545	LOAD_ATTR         'MaxCamP'
548	LOAD_FAST         'self'
551	LOAD_ATTR         '_camAdjust'
554	STORE_ATTR        'upper'

557	LOAD_FAST         'self'
560	LOAD_ATTR         'camPivot'
563	LOAD_ATTR         'setP'
566	LOAD_FAST         'self'
569	LOAD_ATTR         'DefaultCamP'
...
579	LOAD_FAST         'task'
582	LOAD_CONST        None
585	COMPARE_OP        'is not'
588	JUMP_IF_FALSE     '654'

591	LOAD_FAST         'self'
594	LOAD_ATTR         'curCamPivot'
597	LOAD_ATTR         'setP'
600	LOAD_FAST         'self'
603	LOAD_ATTR         'curCamPivot'

606	LOAD_FAST         'self'
609	LOAD_ATTR         'targetCamPivot'
612	LOAD_ATTR         'getP'
615	LOAD_FAST         'self'
618	LOAD_ATTR         'curCamPivot'
621	CALL_FUNCTION_1   None
624	LOAD_GLOBAL       'min'
627	LOAD_CONST        1.0
630	LOAD_CONST        1.0
633	LOAD_GLOBAL       'globalClock'
636	LOAD_ATTR         'getDt'
639	CALL_FUNCTION_0   None
642	BINARY_MULTIPLY   None
643	CALL_FUNCTION_2   None
646	BINARY_MULTIPLY   None
647	CALL_FUNCTION_2   None
650	POP_TOP           None
651	JUMP_FORWARD      '654'
654_0	COME_FROM         '651'

654	LOAD_FAST         'self'
657	LOAD_ATTR         'curCamPivot'
660	LOAD_ATTR         'getP'
663	CALL_FUNCTION_0   None
666	STORE_FAST        'curP'

669	LOAD_FAST         'self'
672	LOAD_ATTR         'curCamPivot'
675	LOAD_ATTR         'setP'
678	LOAD_FAST         'self'
681	LOAD_ATTR         'DefaultCamP'
684	CALL_FUNCTION_1   None
687	POP_TOP           None

688	LOAD_GLOBAL       'base'
691	LOAD_ATTR         'camera'
694	LOAD_ATTR         'reparentTo'
697	LOAD_FAST         'self'
700	LOAD_ATTR         'ballFollow'
703	CALL_FUNCTION_1   None
706	POP_TOP           None

707	LOAD_GLOBAL       'base'
710	LOAD_ATTR         'camera'
713	LOAD_ATTR         'setPos'
716	LOAD_FAST         'self'
719	LOAD_ATTR         'camPosBallFollow'
722	CALL_FUNCTION_1   None
725	POP_TOP           None

726	LOAD_GLOBAL       'base'
729	LOAD_ATTR         'camera'
732	LOAD_ATTR         'setHpr'
735	LOAD_FAST         'self'
738	LOAD_ATTR         'camHprBallFollow'
741	CALL_FUNCTION_1   None
744	POP_TOP           None

745	LOAD_GLOBAL       'base'
748	LOAD_ATTR         'camera'
751	LOAD_ATTR         'wrtReparentTo'
754	LOAD_FAST         'self'
757	LOAD_ATTR         'curCamPivot'
760	CALL_FUNCTION_1   None
763	POP_TOP           None

764	LOAD_FAST         'self'
767	LOAD_ATTR         'curCamPivot'
770	LOAD_ATTR         'setP'
773	LOAD_FAST         'curP'
776	CALL_FUNCTION_1   None
779	POP_TOP           None

780	LOAD_GLOBAL       'base'
783	LOAD_ATTR         'camera'
786	LOAD_ATTR         'wrtReparentTo'
789	LOAD_FAST         'self'
792	LOAD_ATTR         'ballFollow'
795	CALL_FUNCTION_1   None
798	POP_TOP           None

799	LOAD_GLOBAL       'Task'
802	LOAD_ATTR         'cont'
805	RETURN_VALUE      None

Syntax error at or near `POP_BLOCK' token at offset 68
    ...
    def handleBallHitNonGrass(self, c0, c1):
        ...
        if GolfGlobals.HARD_COLLIDE_ID in [c0, c1]:
            if not self.bumpHardSfx.status() == self.bumpHardSfx.PLAYING:
                ...
                if distance > 2.0:
                    base.playSfx(self.bumpHardSf
# Can't uncompyle C:\Users\Maverick\Documents\Visual Studio 2010\Projects\Unfreezer\py2\toontown\golf\DistributedGolfHole.pyc
