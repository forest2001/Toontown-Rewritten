    ...
    def hideSittingToons(self):
        for avId in self.avIds:
            if avId:
                ...
                if av:
                    av.hide()
# okay decompyling C:\Users\Maverick\Documents\Visual Studio 2010\Projects\Unfreezer\py2\toontown\safezone\DistributedGolfKart.pyc 
# decompiled 1 files: 1 okay, 0 failed, 0 verify failed
# 2013.08.22 22:24:33 Pacific Daylight Time
