...
# Embedded file name: direct.directutil.Mopath
...
class Mopath(DirectObject):
    ...
    def __playTask(self, state):
        ...
        return Task.cont
# okay decompyling C:\Users\Maverick\Documents\Visual Studio 2010\Projects\Unfreezer\py2\direct\directutil\Mopath.pyc 
