...
# Embedded file name: direct.showbase.ObjectReport
...
class ObjectReport():
    ...
    def _getObjectList(self):
        if hasattr(sys, 'getobjects'):
            ...
            return objects
# okay decompyling C:\Users\Maverick\Documents\Visual Studio 2010\Projects\Unfreezer\py2\direct\showbase\ObjectReport.pyc 
