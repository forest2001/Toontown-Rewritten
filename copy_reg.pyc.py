    ...
    if not hasattr(cls, '__slots__'):
        ...
        for c in cls.__mro__:
            if '__slots__' in c.__dict__:
                names += [ name for name in c.__dict__['__slots__'] if name not in ('__dict__', '__weakref__') ]
...
# okay decompyling C:\Users\Maverick\Documents\Visual Studio 2010\Projects\Unfreezer\py2\copy_reg.pyc 
