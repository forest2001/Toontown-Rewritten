...
# Embedded file name: sre_compile
import _sre, sys
...
def _compile(code, pattern, flags):
    emit = code.append
    _len = len
    LITERAL_CODES = {LITERAL: 1,
     NOT_LITERAL: 1}
    REPEATING_CODES = {REPEAT: 1,
     MIN_REPEAT: 1,
     MAX_REPEAT: 1}
    SUCCESS_CODES = {SUCCESS: 1,
     FAILURE: 1}
    ASSERT_CODES = {ASSERT: 1,
     ASSERT_NOT: 1}
...
# okay decompyling C:\Users\Maverick\Documents\Visual Studio 2010\Projects\Unfreezer\py2\sre_compile.pyc 
